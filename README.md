# Affective Go/No-Go Task Go/No-Go Task - Eyetracking Ver.

**This is the eyetracking task version. For non-eyetracking version, see (click here)[https://github.com/mjcolwell/emotional_go_no_go].**
...
In addition, this new version of the task includes an pupilometry component. It is optimised for the Eyelink 1000 Plus. This is currently an experimental feature which will be explored in an upcoming study. To use the non-eyetracking version of the task, see 'branches'. This special version has changes included increased post ISI window (to capture full pupilometry dynamics) and decreased trial numbers to compensate for increase length (control trials are reduced by *N*=40).
